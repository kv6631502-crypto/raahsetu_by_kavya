...
export const TRANSLATIONS: Record<SupportedLanguage, Translations> = {
  en: {
    ...
    darkMode: "Dark Mode",
    activeIncidentsBanner: "Planning Scenarios (4 Corridor Test Cases)",
    inspect: "Inspect",
    dismiss: "Dismiss",
    ...
    heroBadge: "Northeast Freight Corridor Prototype · 8 States",
    welcomeTo: "Welcome to",
    heroSubtitle: "AI-Powered Climate-Resilient Logistics Grid",
    heroDescription: "Explainable, multi-criteria freight routing for a curated Northeast corridor graph. The current prototype uses versioned scenario risk; live authority, weather, bridge, and traffic feeds require configured integrations.",
    getStarted: "Get Started",
    openDispatcher: "Open Dispatcher",
    driverLogin: "Driver Login",
    statStates: "8 States",
    statStatesSub: "Northeast Arterial Coverage",
    statHazards: "Scenario Risk Layers",
    statHazardsSub: "Evidence review required",
    statSolvers: "Fastest vs Risk-A*",
    statSolversSub: "Multi-Objective Engine",
    statBeacons: "111 Prototype Hubs",
    statBeaconsSub: "Curated corridor graph",

    advisoriesTitle: "Mountain Road Planning Scenarios",
    advisoriesSubtitle: "Illustrative corridor cases for route-engine testing; not live closure notices",
    inspectInDispatcher: "Inspect in Dispatcher",
    critical: "CRITICAL",
    high: "HIGH",
    avoidTraffic: "Avoid / Caution",
    recommendedDetour: "Recommended Detour",
    liveHighwayAdvisory: "Highway Safety Advisory",
    ...
    pillar1Title: "Vehicle Constraint Modelling",
    pillar1Desc: "Applies configured vehicle-class constraints to the prototype graph. Verified bridge capacities and clearance feeds are an integration requirement.",
    pillar2Title: "Dual-Path Deterministic Routing",
    pillar2Desc: "Computes fastest and risk-aware alternatives from versioned corridor weights and documented scenario hazards.",
    pillar3Title: "Offline Field-Report Queue",
    pillar3Desc: "Queues field reports in IndexedDB for later sync. Offline basemaps, service-worker caching, and authenticated sync need deployment configuration.",
    ...
    districtHealthSubtitle: "Prototype connectivity scenarios and corridor review records. Real-time status requires verified authority and field-data integrations.",
    ...
    dataPageSubtitle: "Deterministic dual-objective routing engine using a curated corridor graph and versioned scenario risk. OSM, GSI, and IMD integrations are planned data sources.",
    monsoonLandslides: "Scenario Landslide Layer",
    gsiRecorded: "Prototype risk layer; verify against an approved source before operational use.",
    ...
    stat4Value: "34%+ Safety Margin",
    stat4Label: "Risk-km Exposure Reduction",
    stat4Desc: "Admissible Risk-A* algorithm detours heavy logistics convoys and dangerous POL tankers away from active rockfall zones and unstable river crossings.",
    stat4Source: "Source: RaahSetu Evaluation Benchmark",
    ...
    osmGraphActive: "Curated Corridor Graph · Prototype",
    ...
    microclimateIngestion: "Weather scenario",
